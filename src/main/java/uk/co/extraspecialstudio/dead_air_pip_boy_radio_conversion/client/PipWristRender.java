 ...
 */
@Mod.EventBusSubscriber(modid = Dead_air_pip_boy_radio_conversion.MODID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.FORGE)
public final class PipWristRender {
    ...
    private static void draw(
        ...
        var custom = IClientItemExtensions.of(stack).getCustomRenderer();
